                        ...
                        Button(
                            onClick = {
                                coroutineScope.launch {
                                    //var credential: MDoc? = null

                                    /*try {
                                         credential = DrivingCredentialRequest(applicationContext).getCredential(applicationContext)!!
                                    }catch (e: Exception){
                                        Logger.d("CREDENTIAL ERROR", e.stackTrace.toString())
                                    }
                                    ...
                                    try {
                                        ...
                                        Logger.d("CREDENTIAL ISSUANCE ERROR", e.message.toString())
                                        Toast.makeText(
                                            applicationContext,
                                            "CREDENTIAL ISSUANCE FAILED ",
                                            Toast.LENGTH_LONG
